...
class LibraryConventionPluginTest extends PluginTest {

	def setup() {
		buildFile << """
            plugins {
                id 'de.cimt.library-conventions'
            }
        """
	}
    ...
    def "publishes library with versioning"() {
        given:
        readmeContainingMandatorySectionsExists()
        ...
        new File(testProjectDir, 'src/main/java/de/cimt/Util.java') << """
            package de.thpeetz;
        ...
        new File(testProjectDir, 'build/test-repo/de/cimt/my-library/0.1.0/my-library-0.1.0.jar').exists()
    }
